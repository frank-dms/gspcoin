...
uint256 hashGenesisBlock("0xcdae26ed9270b047f878f4c1ecf80d153eb0dd2c0fee644dd5480bbd130dd55a");
...
const string strMessageMagic = "GSPCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // GSPCoin: 1 days
static const int64 nTargetSpacing = 120; // GSPCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal gspcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GSPCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x63dbdfbee60274b50d7af4b90f535f33f3c35de25fa025932fc364c6e18286a4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "BBC Newspaper headlines: May's Brexit plan and SAS pose as homeless";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1497654860; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 98651;

        if (fTestNet)
        {
            block.nTime    = 1497497221;
            block.nNonce   = 2294673;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf9aa5fbbc577949f54dd554449fd6c24c16f7ba08e5f53bd57c2e939bbdb916f"));
